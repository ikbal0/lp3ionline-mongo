...
export default function DashboardPage(){
    return(
        <>
            ...
            <div class="row row-cols-2" style={{backgroundColor:'#002b8f',paddingTop: 10, paddingRight: 20, paddingBottom:10}}>
                <div class="col" style={{color:'white', paddingTop: 10, paddingLeft: 40}}>
                    Admin
                </div>
            ...
            <div class="row">
                <div class="col-xl-2 " style={{backgroundColor:'#f5f5f5', paddingLeft:30, paddingTop:30}}>
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" aria-current="page" href="#"><svg xmlns="http://www.w3.org/2000/svg" style={{paddingBottom:5, paddingRight:10}} height="30px" viewBox="0 0 24 24" width="30px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M21 3H3c-1.11 0-2 .89-2 2v12c0 1.1.89 2 2 2h5v2h8v-2h5c1.1 0 1.99-.9 1.99-2L23 5c0-1.11-.9-2-2-2zm0 14H3V5h18v12z"/></svg>Kelas online</a>
                        </li>
                    </ul>

                </div>
                <div class="col">
                    <nav class="navbar navbar-light bg-light" style={{padding:5, paddingLeft:10}}>
                        <a class="navbar-brand" href="#">
                            <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 0 24 24" width="30px" fill="#000000" style={{paddingBottom:6}}><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 6c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2m0 10c2.7 0 5.8 1.29 6 2H6c.23-.72 3.31-2 6-2m0-12C9.79 4 8 5.79 8 8s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 10c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" fill-opacity="1"/></svg>
                            Dosen
                            
                        </a>
                    </nav>
                    <div class="dropdown border-bottom" style={{paddingBottom: 10, paddingLeft:10}}>
